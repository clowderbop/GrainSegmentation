...
def build_unet(patch_size, num_inputs=1, hp=None, base_filters=None):
    ...
    conv1 = Conv2D(f1, (3, 3), activation="relu", padding="same")(x)
    conv1 = Conv2D(f1, (3, 3), activation="relu", padding="same")(conv1)
    conv1 = BatchNormalization()(conv1)

    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)
    conv2 = Conv2D(f2, (3, 3), activation="relu", padding="same")(pool1)
    conv2 = Conv2D(f2, (3, 3), activation="relu", padding="same")(conv2)
    conv2 = BatchNormalization()(conv2)

    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)
    conv3 = Conv2D(f3, (3, 3), activation="relu", padding="same")(pool2)
    conv3 = Conv2D(f3, (3, 3), activation="relu", padding="same")(conv3)
    conv3 = BatchNormalization()(conv3)

    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)
    conv4 = Conv2D(f4, (3, 3), activation="relu", padding="same")(pool3)
    conv4 = Conv2D(f4, (3, 3), activation="relu", padding="same")(conv4)
    ...
    conv7 = Conv2D(f3, (3, 3), activation="relu", padding="same")(up7)
    conv7 = Conv2D(f3, (3, 3), activation="relu", padding="same")(conv7)
    conv7 = BatchNormalization()(conv7)

    up8 = Conv2DTranspose(f2, (3, 3), strides=(2, 2), padding="same")(conv7)
    up8 = concatenate([up8, conv2])
    conv8 = Conv2D(f2, (3, 3), activation="relu", padding="same")(up8)
    conv8 = Conv2D(f2, (3, 3), activation="relu", padding="same")(conv8)
    conv8 = BatchNormalization()(conv8)

    up9 = Conv2DTranspose(f1, (3, 3), strides=(2, 2), padding="same")(conv8)
    up9 = concatenate([up9, conv1])
    conv9 = Conv2D(f1, (3, 3), activation="relu", padding="same")(up9)
    conv9 = Conv2D(f1, (3, 3), activation="relu", padding="same")(conv9)
