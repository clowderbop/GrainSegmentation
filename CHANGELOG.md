...
- Export full test YOLO patches without tile train/val split
  ([`6cc47b3`](https://github.com/clowderbop/GrainSegmentation/commit/6cc47b3a39d020a9696a8a0acd1046d183bca4c6))
...
- **slurm**: Reorganize training and test scripts
  ([`bb8eae1`](https://github.com/clowderbop/GrainSegmentation/commit/bb8eae1dbee8df53832569cbdf2e704bdd517115))
...
- Add U-Net patch mask cropper aligned to YOLO exports
  ([`c1d33d8`](https://github.com/clowderbop/GrainSegmentation/commit/c1d33d81eec3c29c65d4d8566dd179b12596297b))

- Add crop_unet_masks_from_yolo_patches.py, SLURM wrappers, and unit tests\n- Extend evaluation and
  train_yolo SLURM tests; refresh README; remove CHANGELOG\n- Point train_yolo usage at
  train_yolo_submit.sh

Co-authored-by: Cursor <cursoragent@cursor.com>

- **slurm**: Align pipeline with train_/test_ dataset TIFF naming
  ([`59500bd`](https://github.com/clowderbop/GrainSegmentation/commit/59500bd43644faf5732fd6e93f901ba527280171))

Co-authored-by: Cursor <cursoragent@cursor.com>

- **yolo**: Add SAHI instance metrics matching U-Net eval
  ([`79dfbaa`](https://github.com/clowderbop/GrainSegmentation/commit/79dfbaaaedfe5fb1158a27933348038763a06b82))

- **yolo**: Export evaluation metrics and artifacts
  ([`0e36c77`](https://github.com/clowderbop/GrainSegmentation/commit/0e36c77f3f882b63692abbedb5f4a1a049b3e8b2))
...
- **eval**: Remove COCO AP and speed up instance metrics
  ([`d4e6258`](https://github.com/clowderbop/GrainSegmentation/commit/d4e625897b0063008689cd21ecf328cca491e00f))
...
- Add missing slurm script
  ([`fc42444`](https://github.com/clowderbop/GrainSegmentation/commit/fc424441b5046ae7eb68a21c60ebc416d3b01fbe))

- Added missing dep (again)
  ([`87e71e5`](https://github.com/clowderbop/GrainSegmentation/commit/87e71e54a02e3d56a31615f960c416e7d6fc9358))

### Documentation

- Update readme
  ([`d8966b2`](https://github.com/clowderbop/GrainSegmentation/commit/d8966b26ad3736b4b36f7dce53f023906e364ba2))

### Features

- Add caching
  ([`cbbd4d8`](https://github.com/clowderbop/GrainSegmentation/commit/cbbd4d8808b05b0251e3b1104def7f0374a8a51a))

- Per-variant watershed eval and training test fixes
  ([`2a0c7d4`](https://github.com/clowderbop/GrainSegmentation/commit/2a0c7d4dfa6548a9677ad01e16da8aab89f46ad5))

- **evaluation**: Coco mask AP for U-Net; align AJI instance method
  ([`1620efc`](https://github.com/clowderbop/GrainSegmentation/commit/1620efcaa09aab5f89b3744d5f21f36ecaadb9b0))

- **evaluation**: Instance-only metrics and fix PRF empty cases
  ([`500f22d`](https://github.com/clowderbop/GrainSegmentation/commit/500f22dd0d4d66015c121a8b1af0f466b6f5f94c))
...
- Add missing dependency
  ([`0f3c47a`](https://github.com/clowderbop/GrainSegmentation/commit/0f3c47a1ee989b4783e0fbac5218d65fad822f00))
...
- **yolo**: Val name, manifest paths, SAHI metrics JSON
  ([`7d67e4d`](https://github.com/clowderbop/GrainSegmentation/commit/7d67e4dc3926633ee4762e45f81084b8a5765607))
...
- Add watershed validation tuning script and SLURM job
  ([`bd33972`](https://github.com/clowderbop/GrainSegmentation/commit/bd33972c9131ea39b77d29fe4716e4d57269e221))

- Asdded script to submit watershed tuning for all variants
  ([`d4741a8`](https://github.com/clowderbop/GrainSegmentation/commit/d4741a82a49e18b75c95f4a7584260e730ddf841))

- **yolo**: Run Ultralytics eval on test split, default name test
  ([`cf41685`](https://github.com/clowderbop/GrainSegmentation/commit/cf41685f6a9dad96f342d1575d955f96dc3c68f5))
...
- **evaluation**: Instance masks from semantic preds (CC + watershed)
  ([`3e7a81a`](https://github.com/clowderbop/GrainSegmentation/commit/3e7a81a1e8b724b28970c38acafbf412c4d2d7b0))

### Refactoring

- **yolo**: Simplify eval to val/sahi, rename sahi-coco
  ([`676bb09`](https://github.com/clowderbop/GrainSegmentation/commit/676bb099f9d711c38d3b8493fa237eb3f077fde3))
...
- Fixed outdated tests
  ([`4d012bd`](https://github.com/clowderbop/GrainSegmentation/commit/4d012bdab0b1e9972bd8ebd3c33b12cdd1a2779c))

### Features

- Added yolo evaluation
  ([`afd0236`](https://github.com/clowderbop/GrainSegmentation/commit/afd02367983908d0704cadc4a9516a681b610799))
...
- Add missing dep declaration in evaluation package
  ([`f97035a`](https://github.com/clowderbop/GrainSegmentation/commit/f97035aaa40f5fa096606d3867a4ff061e6708ac))

- Change training time
  ([`787134b`](https://github.com/clowderbop/GrainSegmentation/commit/787134b787d5fb2dfe82c082dc850fdd398878e0))

### Features

- Add script to make tuning figures
  ([`2f2cd33`](https://github.com/clowderbop/GrainSegmentation/commit/2f2cd337eb6e17b28ad29bfe03f3d8ccf619c307))
...
- Enhance YOLO training and tuning capabilities
  ([`70ab526`](https://github.com/clowderbop/GrainSegmentation/commit/70ab52658c12a6dc47da49e49c65f538bd4477d8))
...
- Enhance YOLO training scripts with learning rate and dropout parameters
  ([`b5acae5`](https://github.com/clowderbop/GrainSegmentation/commit/b5acae5d3a749070b650fa4d4866192c449d0862))
...
- Adjusted batch size and epochs
  ([`ef29669`](https://github.com/clowderbop/GrainSegmentation/commit/ef296690702c0407bcfbd6895863016a5bc60336))

- Update dataset YAML path handling in YOLO training script
  ([`9cc1616`](https://github.com/clowderbop/GrainSegmentation/commit/9cc161602a343c23e08815a4bffa1942181e40f4))
...
- Add script to split stacked TIFF channels into RGB TIFFs
  ([`859d006`](https://github.com/clowderbop/GrainSegmentation/commit/859d006846d37875ad871cbd81075335b0bc95a6))
...
- Add visualization script for YOLO dataset
  ([`dada6b5`](https://github.com/clowderbop/GrainSegmentation/commit/dada6b515bf3dda8e3474a21b0351f963ba232a7))
...
- Add yolo26 training pipeline
  ([`8e9a6c1`](https://github.com/clowderbop/GrainSegmentation/commit/8e9a6c11b8dca249e86c38d8fb52601cbf6fe4c1))
...
- Add patchify script for splitting TIFF and GPKG files into YOLO format
  ([`58c2abf`](https://github.com/clowderbop/GrainSegmentation/commit/58c2abfc63ab39787c1e1918eb6ee1dc40239323))
...
- Add raster-to-polygon slurm job
  ([`29dd8e1`](https://github.com/clowderbop/GrainSegmentation/commit/29dd8e1c9647c72c93c629f94c1a2d416791ff1c))

- Add tiff channel stacking script
  ([`dc4abed`](https://github.com/clowderbop/GrainSegmentation/commit/dc4abedcd334271a0776a9b08a678efb1273b744))
...
- Add raster-to-gpkg export
  ([`4c997ec`](https://github.com/clowderbop/GrainSegmentation/commit/4c997ecf1f0f5f9b379c284795465621b1ca3c2a))

- Add split TIFF+GPKG to YOLO train/val export script
  ([`79f9330`](https://github.com/clowderbop/GrainSegmentation/commit/79f9330fc1b349b37268c071ea2a130770592457))

- Enhance SLURM scripts for raster processing and add new utilities
  ([`539eb3d`](https://github.com/clowderbop/GrainSegmentation/commit/539eb3d1d7aa7c6d0995e3af004f46e5fb6ac853))
...
- Split qualitative overlays by model
  ([`600c5ac`](https://github.com/clowderbop/GrainSegmentation/commit/600c5ac6cb212a5dc99cc4c6bd919f8a254cbca1))
...
- Add reusable evaluation slurm workflow
  ([`5565f3c`](https://github.com/clowderbop/GrainSegmentation/commit/5565f3ca4886deb273d92673e0079320f7ad19d7))

### Refactoring

- Use spatial holdout validation
  ([`863cca8`](https://github.com/clowderbop/GrainSegmentation/commit/863cca8120aec7c6c3217bef8066e8cc921451c6))
...
- Update TensorFlow stderr filter patterns and adjust SLURM job memory allocation
  ([`fdd175b`](https://github.com/clowderbop/GrainSegmentation/commit/fdd175b759776b6e6b373b84b4770394e027a2a8))
...
- Log frozen CV epoch selection start
  ([`8c3faa2`](https://github.com/clowderbop/GrainSegmentation/commit/8c3faa21a6491c6f3de8c02e090b3489b7e3147d))

### Documentation

- Update README to clarify final test evaluation and ablation study interpretation
  ([`11fbbf1`](https://github.com/clowderbop/GrainSegmentation/commit/11fbbf1d525a9bce993006872d353fde3874a604))
...
- Reuse fold caches during tuning
  ([`390b542`](https://github.com/clowderbop/GrainSegmentation/commit/390b5426135e929abed705355b770f82769a8093))

### Refactoring

- Align evaluation reporting with single-image test
  ([`ea99a5c`](https://github.com/clowderbop/GrainSegmentation/commit/ea99a5c6ef8fb98f1a0682099afd89964ba19ec8))
...
- Add frozen CV epoch selection
  ([`f030cf9`](https://github.com/clowderbop/GrainSegmentation/commit/f030cf9c7fddd96b887d8554e965bd306ce6a275))
...
- Make training restarts predictable
  ([`9002951`](https://github.com/clowderbop/GrainSegmentation/commit/90029513338fc24dfa5ec1822911f6bfbf0be392))
...
- Add guidelines for brief Conventional Commits and SLURM-safe execution
  ([`d224c71`](https://github.com/clowderbop/GrainSegmentation/commit/d224c7198cbde8f9b045e967ed82af8815ebe29b))
...
- Filter TensorFlow stderr in SLURM jobs, add --verbose and training summaries
  ([`29f5677`](https://github.com/clowderbop/GrainSegmentation/commit/29f56770f952fafc3f4d2681e91c32933684a34b))
...
- Remove outdated project reorganization plans
  ([`ce78630`](https://github.com/clowderbop/GrainSegmentation/commit/ce7863073bb163e45e18375004b9e343aa4a701d))
...
- Update Python version and enhance README documentation
  ([`3fbe2e6`](https://github.com/clowderbop/GrainSegmentation/commit/3fbe2e6fcd0b0dcf6d3e34d6b668bf26b1cdce8a))
...
- Enhance data validation and error handling in dataset building
  ([`f117b41`](https://github.com/clowderbop/GrainSegmentation/commit/f117b416e2a20e7e3defd4e9b90551aeccaaca12))
...
- Implement evaluation framework for grain segmentation models
  ([`435cee2`](https://github.com/clowderbop/GrainSegmentation/commit/435cee244e73eee425650557bbbdf85ba0375936))
...
- Simplify U-Net model configuration and training parameters
  ([`725c423`](https://github.com/clowderbop/GrainSegmentation/commit/725c423ccf8b77eaf18466591506ce25f3e0d560))
...
- Update SLURM scripts and training parameters
  ([`d263aa3`](https://github.com/clowderbop/GrainSegmentation/commit/d263aa3a6aa19ae74a707945b229a4850bf1b5c5))
...
- Update README and SLURM scripts for training configuration
  ([`27fea94`](https://github.com/clowderbop/GrainSegmentation/commit/27fea940f0ec74273a0277786775f90619f6bfcd))
...
- Enhance U-Net model with dropout regularization
  ([`da9f4b4`](https://github.com/clowderbop/GrainSegmentation/commit/da9f4b462251613ded59bb42ca86c9c6d96b1646))
...
- Add log plotting script for training metrics
  ([`efd027d`](https://github.com/clowderbop/GrainSegmentation/commit/efd027d4908755d21c18e467d2760ab2948fffee))
...
- Enhance SLURM scripts and training configuration
  ([`d53b169`](https://github.com/clowderbop/GrainSegmentation/commit/d53b169d1a8941e9d0772b33b5717aec568a8616))
...
- Add caching support for dataset preparation in training
  ([`087ac9b`](https://github.com/clowderbop/GrainSegmentation/commit/087ac9b82e783811963f7e8efd307f53c5829670))
...
- Enhance SLURM scripts and training logic
  ([`46df58a`](https://github.com/clowderbop/GrainSegmentation/commit/46df58a46e2ce3652a236d1e96eebc3f19a3da68))
...
- Add skip-tuning option and adjust training parameters
  ([`1355c83`](https://github.com/clowderbop/GrainSegmentation/commit/1355c83de770eadc2e87e8447322fd339c7d7e09))
...
- Distribute uv sync to individual SLURM scripts
  ([`dc0a65d`](https://github.com/clowderbop/GrainSegmentation/commit/dc0a65dee65711bcb82e73c1f8f00b09cf06c1c0))

### Chores

- Add pyproject.toml and lockfile for data_prep pipeline
  ([`abd2248`](https://github.com/clowderbop/GrainSegmentation/commit/abd224895c32573284d80f4274ec6f07f4eee978))

Made-with: Cursor

- Add pyproject.toml and lockfile for training pipeline
  ([`7e52941`](https://github.com/clowderbop/GrainSegmentation/commit/7e529417dfefda91491af9ec94cd337a17bbec6a))

Made-with: Cursor

- Create directory structure for independent pipelines
  ([`ecf2c03`](https://github.com/clowderbop/GrainSegmentation/commit/ecf2c03a0df54eee167d2db905ecf345dc521d7f))

Made-with: Cursor

- Remove root pyproject.toml and uv.lock to enforce independent pipelines
  ([`f336f0d`](https://github.com/clowderbop/GrainSegmentation/commit/f336f0dc2a54941dd4790c168eb277ff9355cf78))
...
- Add project reorganization design doc
  ([`20295d3`](https://github.com/clowderbop/GrainSegmentation/commit/20295d3ffdfb03979813509ba3db4ff6aa94e607))

Made-with: Cursor

- Add project reorganization implementation plan
  ([`9696fbc`](https://github.com/clowderbop/GrainSegmentation/commit/9696fbc145099949561f38b0ac7d68c34c64150d))
...
- Move and update SLURM scripts for new pipeline structure
  ([`d4a637a`](https://github.com/clowderbop/GrainSegmentation/commit/d4a637ad4a523c56a3d9935c50f3ff7f44b21f9e))

Made-with: Cursor

- Move preprocess code to data_prep pipeline
  ([`6967ce1`](https://github.com/clowderbop/GrainSegmentation/commit/6967ce140e2b7dbea170412fd04a3b79e379c5b9))

Made-with: Cursor

- Move segmentation code to training pipeline
  ([`f818617`](https://github.com/clowderbop/GrainSegmentation/commit/f81861706608eface59f7cb797c9c907636bf9c9))
...
- Add VSCode configuration for Ruff and formatting
  ([`f44a799`](https://github.com/clowderbop/GrainSegmentation/commit/f44a7999060c528de34505cf08669ba7c90bec27))

### Features

- Add data download script and update project dependencies
  ([`397dd33`](https://github.com/clowderbop/GrainSegmentation/commit/397dd33adf92fd21e32dcc368e666a53366f4567))
...
- Readded version in pyproject again
  ([`11608b8`](https://github.com/clowderbop/GrainSegmentation/commit/11608b8a2d63aa6be9154b475028fccfd7c6b247))

### Chores

- Update versioning configuration and add version module
  ([`fb88f5c`](https://github.com/clowderbop/GrainSegmentation/commit/fb88f5c224754b6b9b4f08511543845566a58e03))

### Refactoring

- Added src folder and main file
  ([`65640bf`](https://github.com/clowderbop/GrainSegmentation/commit/65640bf5c750ae9fdd00b054bdc1bdd3eafafcf4))
