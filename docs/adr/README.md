...
This directory records decisions, not operational runbooks or glossary entries.
...
Use [`CONTEXT.md`](../../CONTEXT.md) for domain terms, [`docs/metrics.md`](../metrics.md) for metric definitions, and [`docs/runbooks/`](../runbooks/) for cluster operations.
